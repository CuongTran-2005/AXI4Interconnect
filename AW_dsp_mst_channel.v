...
(	
    ...
    localparam DATA_IN_MUX_WIDTH = TRANS_MST_ID_W + ADDR_WIDTH + TRANS_BURST_W + TRANS_DATA_LEN_W + TRANS_DATA_SIZE_W + TRANS_QOS_W + 1;
    ...
    //in out demux
    assign demux_in = {m_AWID_i, m_AWADDR_i, m_AWBURST_i, m_AWLEN_i, m_AWSIZE_i, m_AWQOS_i, m_AWVALID_i};
    genvar idx;
    generate
