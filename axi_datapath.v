module axi_datapath #(
	...
	output [ADDR_WIDTH * MST_AMT-1:0]           	    ctl_AWADDR_o,
	 
    input [SLV_ID_W * MST_AMT-1:0] 					ctl_slave_id_ar_i,
    input [SLV_ID_W * MST_AMT-1:0] 					ctl_slave_id_r_i,
	output [ADDR_WIDTH * MST_AMT-1:0]                ctl_ARADDR_o,

    //valid signal for master dsp
    input [MST_AMT -1:0]								ctl_mst_dsp_aw_valid_i,
    input [MST_AMT -1:0]								ctl_mst_dsp_ar_valid_i,
    input [MST_AMT -1:0]								ctl_mst_dsp_w_valid_i,
    output  [MST_AMT -1:0]								ctl_mst_dsp_r_valid_o,
    output  [MST_AMT -1:0]								ctl_mst_dsp_b_valid_o,
    //ready signal for master dsp
    output [MST_AMT -1:0]								ctl_mst_dsp_aw_ready_o,
    output [MST_AMT -1:0]								ctl_mst_dsp_ar_ready_o,
    output [MST_AMT -1:0]								ctl_mst_dsp_w_ready_o,
    input [MST_AMT -1:0]								ctl_mst_dsp_r_ready_i,
    input [MST_AMT -1:0]								ctl_mst_dsp_b_ready_i,
    ...
    output [SLV_AMT -1:0]								ctl_slv_dsp_aw_valid_o,
    output [SLV_AMT -1:0]								ctl_slv_dsp_ar_valid_o,
    output [SLV_AMT -1:0]								ctl_slv_dsp_w_valid_o,
    input [SLV_AMT -1:0]								ctl_slv_dsp_r_valid_i,
    input  [SLV_AMT -1:0]								ctl_slv_dsp_b_valid_i,
    //ready signal for slave dsp
    input [SLV_AMT -1:0]								ctl_slv_dsp_aw_ready_i,
    input [SLV_AMT -1:0]								ctl_slv_dsp_ar_ready_i,
    input [SLV_AMT -1:0]								ctl_slv_dsp_w_ready_i,
    output [SLV_AMT -1:0]								ctl_slv_dsp_r_ready_o,
    output [SLV_AMT -1:0]								ctl_slv_dsp_b_ready_o,
    ...
    //master QOS signal
    output [TRANS_QOS_W * MST_AMT-1:0]                ctl_mst_ar_qos_o,
...
//master dsp <-> controler and arbiter
assign mst_dsp_AWVALID = ctl_mst_dsp_aw_valid_i;
assign mst_dsp_ARVALID = ctl_mst_dsp_ar_valid_i;
assign mst_dsp_WVALID = ctl_mst_dsp_w_valid_i;
assign ctl_mst_dsp_r_valid_o = mst_dsp_RVALID;
assign ctl_mst_dsp_b_valid_o = mst_dsp_BVALID;

assign ctl_mst_dsp_aw_ready_o = mst_dsp_AWREADY;
assign ctl_mst_dsp_ar_ready_o = mst_dsp_ARREADY;
assign ctl_mst_dsp_w_ready_o = mst_dsp_WREADY;
assign mst_dsp_RREADY = ctl_mst_dsp_r_ready_i;
assign mst_dsp_BREADY = ctl_mst_dsp_b_ready_i;
//slave dsp <-> controler and arbiter
assign ctl_slv_dsp_aw_valid_o = slv_dsp_AWVALID;
assign ctl_slv_dsp_ar_valid_o = slv_dsp_ARVALID;
assign ctl_slv_dsp_w_valid_o = slv_dsp_WVALID;
assign slv_dsp_RVALID = ctl_slv_dsp_r_valid_i;
assign slv_dsp_BVALID = ctl_slv_dsp_b_valid_i;

assign slv_dsp_AWREADY = ctl_slv_dsp_aw_ready_i;
assign slv_dsp_ARREADY = ctl_slv_dsp_ar_ready_i;
assign slv_dsp_WREADY = ctl_slv_dsp_w_ready_i;
assign ctl_slv_dsp_r_ready_o = slv_dsp_RREADY;
assign ctl_slv_dsp_b_ready_o = slv_dsp_BREADY;
...
wire [MST_AMT-1:0]                       mst_dsp_ARVALID;
wire [MST_AMT-1:0]                       mst_dsp_ARREADY;
// wire [MST_AMT-1:0]                       mst_ARVALID;
// wire [MST_AMT-1:0]                       mst_ARREADY;
...
wire [MST_AMT-1:0]                       mst_dsp_AWVALID;
wire [MST_AMT-1:0]                       mst_dsp_AWREADY;
// wire [MST_AMT-1:0]                       mst_AWVALID;
// wire [MST_AMT-1:0]                       mst_AWREADY;
...
wire [MST_AMT-1:0]                       mst_dsp_WVALID;
wire [MST_AMT-1:0]                       mst_dsp_WREADY;
// wire [MST_AMT-1:0]                       mst_WVALID;
// wire [MST_AMT-1:0]                       mst_WREADY;
...
wire [MST_AMT-1:0]                       mst_dsp_RVALID;
wire [MST_AMT-1:0]                       mst_dsp_RREADY;
// wire [MST_AMT-1:0]                       mst_RVALID;
// wire [MST_AMT-1:0]                       mst_RREADY;
...
wire [MST_AMT-1:0]                       mst_dsp_BVALID;
wire [MST_AMT-1:0]                       mst_dsp_BREADY;
// wire [MST_AMT-1:0]                       mst_BVALID;
// wire [MST_AMT-1:0]                       mst_BREADY;
...
wire [MST_AMT*SLV_AMT-1:0]                     xbar_ARVALID;
wire [MST_AMT*SLV_AMT-1:0]                     xbar_ARREADY;
...
wire [MST_AMT*SLV_AMT-1:0]                     xbar_AWVALID;
wire [MST_AMT*SLV_AMT-1:0]                     xbar_AWREADY;

//--------------- W ------------------
wire [DATA_WIDTH*MST_AMT*SLV_AMT-1:0]          xbar_WDATA;
wire [MST_AMT*SLV_AMT-1:0]                     xbar_WLAST;
wire [MST_AMT*SLV_AMT-1:0]                     xbar_WVALID;
wire [MST_AMT*SLV_AMT-1:0]                     xbar_WREADY;
...
wire [MST_AMT*SLV_AMT-1:0]                     xbar_RVALID;
wire [MST_AMT*SLV_AMT-1:0]                     xbar_RREADY;

//--------------- B ------------------
wire [TRANS_MST_ID_W*MST_AMT*SLV_AMT-1:0]      xbar_BID;
wire [TRANS_WR_RESP_W*MST_AMT*SLV_AMT-1:0]     xbar_BRESP;
wire [MST_AMT*SLV_AMT-1:0]                     xbar_BVALID;
wire [MST_AMT*SLV_AMT-1:0]                     xbar_BREADY;
...
wire [SLV_AMT-1:0]                       slv_dsp_ARVALID;
wire [SLV_AMT-1:0]                       slv_dsp_ARREADY;
// wire [SLV_AMT-1:0]                       slv_ARVALID;
// wire [SLV_AMT-1:0]                       slv_ARREADY;
...
wire [SLV_AMT-1:0]                       slv_dsp_AWVALID;
wire [SLV_AMT-1:0]                       slv_dsp_AWREADY;
// wire [SLV_AMT-1:0]                       slv_AWVALID;
// wire [SLV_AMT-1:0]                       slv_AWREADY;
...
wire [SLV_AMT-1:0]                       slv_dsp_WVALID;
wire [SLV_AMT-1:0]                       slv_dsp_WREADY;
// wire [SLV_AMT-1:0]                       slv_WVALID;
// wire [SLV_AMT-1:0]                       slv_WREADY;
...
wire [SLV_AMT-1:0]                       slv_dsp_RVALID;
wire [SLV_AMT-1:0]                       slv_dsp_RREADY;
// wire [SLV_AMT-1:0]                       slv_RVALID;
// wire [SLV_AMT-1:0]                       slv_RREADY;
...
wire [SLV_AMT-1:0]                       slv_dsp_BVALID;
wire [SLV_AMT-1:0]                       slv_dsp_BREADY;
// wire [SLV_AMT-1:0]                       slv_BVALID;
// wire [SLV_AMT-1:0]                       slv_BREADY;
...
begin : GEN_MST_SIDE_SKID
    ...
    (
        ...
        .m_ARID_i
        (
            m_ARID_i[(mst+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W]
        ),
        .m_ARADDR_i
        (
            m_ARADDR_i[(mst+1)*ADDR_WIDTH-1 -: ADDR_WIDTH]
        ),
        .m_ARBURST_i
        (
            m_ARBURST_i[(mst+1)*TRANS_BURST_W-1 -: TRANS_BURST_W]
        ),
        .m_ARLEN_i
        (
            m_ARLEN_i[(mst+1)*TRANS_DATA_LEN_W-1 -: TRANS_DATA_LEN_W]
        ),
        .m_ARSIZE_i
        (
            m_ARSIZE_i[(mst+1)*TRANS_DATA_SIZE_W-1 -: TRANS_DATA_SIZE_W]
        ),
        .m_ARQOS_i
        (
            m_ARQOS_i[(mst+1)*TRANS_QOS_W-1 -: TRANS_QOS_W]
        ),
        .m_ARVALID_i
        (
            m_ARVALID_i[mst]
        ...
        .m_AWID_i
        (
            m_AWID_i[(mst+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W]
        ),
        .m_AWADDR_i
        (
            m_AWADDR_i[(mst+1)*ADDR_WIDTH-1 -: ADDR_WIDTH]
        ),
        .m_AWBURST_i
        (
            m_AWBURST_i[(mst+1)*TRANS_BURST_W-1 -: TRANS_BURST_W]
        ),
        .m_AWLEN_i
        (
            m_AWLEN_i[(mst+1)*TRANS_DATA_LEN_W-1 -: TRANS_DATA_LEN_W]
        ),
        .m_AWSIZE_i
        (
            m_AWSIZE_i[(mst+1)*TRANS_DATA_SIZE_W-1 -: TRANS_DATA_SIZE_W]
        ),
         .m_AWQOS_i
        (
            m_AWQOS_i[(mst+1)*TRANS_QOS_W-1 -: TRANS_QOS_W]
        ),
        .m_AWVALID_i
        (
            m_AWVALID_i[mst]
        ...
        .m_WDATA_i
        (
            m_WDATA_i[(mst+1)*DATA_WIDTH-1 -: DATA_WIDTH]
        ),
        .m_WLAST_i
        (
            m_WLAST_i[mst]
        ...
        .m_RID_o
        (
            m_RID_o[(mst+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W]
        ),
        .m_RDATA_o
        (
            m_RDATA_o[(mst+1)*DATA_WIDTH-1 -: DATA_WIDTH]
        ),
        .m_RRESP_o
        (
            m_RRESP_o[(mst+1)*TRANS_WR_RESP_W-1 -: TRANS_WR_RESP_W]
        ),
        .m_RLAST_o
        (
            m_RLAST_o[mst]
        ...
        .m_BID_o
        (
            m_BID_o[(mst+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W]
        ),
        .m_BRESP_o
        (
            m_BRESP_o[(mst+1)*TRANS_WR_RESP_W-1 -: TRANS_WR_RESP_W]
        ),
        .m_BVALID_o
        (
            m_BVALID_o[mst]
        ...
        .dsp_ARBURST_o
        (
            mst_ARBURST[(mst+1)*TRANS_BURST_W-1 -: TRANS_BURST_W]
        ),
        .dsp_ARLEN_o
        (
            mst_ARLEN[(mst+1)*TRANS_DATA_LEN_W-1 -: TRANS_DATA_LEN_W]
        ),
        .dsp_ARSIZE_o
        (
            mst_ARSIZE[(mst+1)*TRANS_DATA_SIZE_W-1 -: TRANS_DATA_SIZE_W]
        ),
         .dsp_ARQOS_o
        (
        ...
        .dsp_AWBURST_o
        (
            mst_AWBURST[(mst+1)*TRANS_BURST_W-1 -: TRANS_BURST_W]
        ),
        .dsp_AWLEN_o
        (
            mst_AWLEN[(mst+1)*TRANS_DATA_LEN_W-1 -: TRANS_DATA_LEN_W]
        ),
        .dsp_AWSIZE_o
        (
            mst_AWSIZE[(mst+1)*TRANS_DATA_SIZE_W-1 -: TRANS_DATA_SIZE_W]
        ),
         .dsp_AWQOS_o
        (
        ...
        .dsp_WDATA_o
        (
            mst_WDATA[(mst+1)*DATA_WIDTH-1 -: DATA_WIDTH]
        ),
        .dsp_WLAST_o
        (
            mst_WLAST[mst]
        ...
        .dsp_RID_i
        (
            mst_RID[(mst+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W]
        ),
        .dsp_RDATA_i
        (
            mst_RDATA[(mst+1)*DATA_WIDTH-1 -: DATA_WIDTH]
        ),
        .dsp_RRESP_i
        (
            mst_RRESP[(mst+1)*TRANS_WR_RESP_W-1 -: TRANS_WR_RESP_W]
        ),
        .dsp_RLAST_i
        (
            mst_RLAST[mst]
        ...
        .dsp_BID_i
        (
            mst_BID[(mst+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W]
        ),
        .dsp_BRESP_i
        (
            mst_BRESP[(mst+1)*TRANS_WR_RESP_W-1 -: TRANS_WR_RESP_W]
        ),
        .dsp_BVALID_i
        (
            mst_sk_BVALID[mst]
...
begin : GEN_DSP_MST
    ...
    (
        ...
        .m_ARVALID_i    (mst_dsp_ARVALID[mst]),
        .m_ARREADY_o    (mst_dsp_ARREADY[mst]),
        ...
        .sa_ARVALID_o   (xbar_ARVALID[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        .sa_ARREADY_i   (xbar_ARREADY[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        ...
        .m_RVALID_o     (mst_dsp_RVALID[mst]),
        .m_RREADY_i     (mst_dsp_RREADY[mst]),
        ...
        .sa_RVALID_i    (xbar_RVALID[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        .sa_RREADY_o    (xbar_RREADY[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        ...
        .m_AWVALID_i    (mst_dsp_AWVALID[mst]),
        .m_AWREADY_o    (mst_dsp_AWREADY[mst]),
        ...
        .sa_AWVALID_o   (xbar_AWVALID[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        .sa_AWREADY_i   (xbar_AWREADY[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        ...
        .m_WVALID_i     (mst_dsp_WVALID[mst]),
        .m_WREADY_o     (mst_dsp_WREADY[mst]),

        .sa_WDATA_o     (xbar_WDATA[(mst+1)*DATA_WIDTH*SLV_AMT-1 -: DATA_WIDTH*SLV_AMT]),
        .sa_WLAST_o     (xbar_WLAST[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        .sa_WVALID_o    (xbar_WVALID[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        .sa_WREADY_i    (xbar_WREADY[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        ...
        .m_BVALID_o     (mst_dsp_BVALID[mst]),
        .m_BREADY_i     (mst_dsp_BREADY[mst]),
        ...
        .sa_BVALID_i    (xbar_BVALID[(mst+1)*SLV_AMT-1 -: SLV_AMT]),
        .sa_BREADY_o    (xbar_BREADY[(mst+1)*SLV_AMT-1 -: SLV_AMT])
    );
...
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_ARVALID;
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_ARREADY;
...
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_AWVALID;
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_AWREADY;

//--------------- W ------------------
wire [DATA_WIDTH*SLV_AMT*MST_AMT-1:0]          xbar_to_slv_WDATA;
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_WLAST;
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_WVALID;
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_WREADY;
...
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_RVALID;
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_RREADY;

//--------------- B ------------------
wire [TRANS_MST_ID_W*SLV_AMT*MST_AMT-1:0]      xbar_to_slv_BID;
wire [TRANS_WR_RESP_W*SLV_AMT*MST_AMT-1:0]     xbar_to_slv_BRESP;
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_BVALID;
wire [SLV_AMT*MST_AMT-1:0]                     xbar_to_slv_BREADY;
...
for (slv = 0; slv < SLV_AMT; slv = slv + 1) begin : GEN_XBAR_TO_SLV
    for (mst = 0; mst < MST_AMT; mst = mst + 1) begin : GEN_XBAR_TO_MST
        ...
        //---------------- AR ----------------
        assign xbar_to_slv_ARID[
            ((slv*MST_AMT + mst)+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W
        ] =
        xbar_ARID[
            ((mst*SLV_AMT + slv)+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W
        ];

        assign xbar_to_slv_ARADDR[
            ((slv*MST_AMT + mst)+1)*ADDR_WIDTH-1 -: ADDR_WIDTH
        ] =
        xbar_ARADDR[
            ((mst*SLV_AMT + slv)+1)*ADDR_WIDTH-1 -: ADDR_WIDTH
        ];

        assign xbar_to_slv_ARBURST[
            ((slv*MST_AMT + mst)+1)*TRANS_BURST_W-1 -: TRANS_BURST_W
        ] =
        xbar_ARBURST[
            ((mst*SLV_AMT + slv)+1)*TRANS_BURST_W-1 -: TRANS_BURST_W
        ];

        assign xbar_to_slv_ARLEN[
            ((slv*MST_AMT + mst)+1)*TRANS_DATA_LEN_W-1 -: TRANS_DATA_LEN_W
        ] =
        xbar_ARLEN[
            ((mst*SLV_AMT + slv)+1)*TRANS_DATA_LEN_W-1 -: TRANS_DATA_LEN_W
        ];

        assign xbar_to_slv_ARSIZE[
            ((slv*MST_AMT + mst)+1)*TRANS_DATA_SIZE_W-1 -: TRANS_DATA_SIZE_W
        ] =
        xbar_ARSIZE[
            ((mst*SLV_AMT + slv)+1)*TRANS_DATA_SIZE_W-1 -: TRANS_DATA_SIZE_W
        ];

        assign xbar_to_slv_ARQOS[
            ((slv*MST_AMT + mst)+1)*TRANS_QOS_W-1 -: TRANS_QOS_W
        ] =
        xbar_ARQOS[
            ((mst*SLV_AMT + slv)+1)*TRANS_QOS_W-1 -: TRANS_QOS_W
        ];

        assign xbar_to_slv_ARVALID[slv*MST_AMT+mst] =
               xbar_ARVALID[mst*SLV_AMT+slv];

        assign xbar_ARREADY[mst*SLV_AMT+slv] =
               xbar_to_slv_ARREADY[slv*MST_AMT+mst];

        //---------------- AW ----------------
        assign xbar_to_slv_AWID[
            ((slv*MST_AMT + mst)+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W
        ] =
        xbar_AWID[
            ((mst*SLV_AMT + slv)+1)*TRANS_MST_ID_W-1 -: TRANS_MST_ID_W
        ...
        assign xbar_to_slv_AWVALID[slv*MST_AMT+mst] =
               xbar_AWVALID[mst*SLV_AMT+slv];

        assign xbar_AWREADY[mst*SLV_AMT+slv] =
               xbar_to_slv_AWREADY[slv*MST_AMT+mst];

        //---------------- W ----------------
        assign xbar_to_slv_WDATA[
            ((slv*MST_AMT + mst)+1)*DATA_WIDTH-1 -: DATA_WIDTH
        ] =
        xbar_WDATA[
            ((mst*SLV_AMT + slv)+1)*DATA_WIDTH-1 -: DATA_WIDTH
        ];

        assign xbar_to_slv_WLAST[slv*MST_AMT+mst] =
               xbar_WLAST[mst*SLV_AMT+slv];

        assign xbar_to_slv_WVALID[slv*MST_AMT+mst] =
               xbar_WVALID[mst*SLV_AMT+slv];

        assign xbar_WREADY[mst*SLV_AMT+slv] =
               xbar_to_slv_WREADY[slv*MST_AMT+mst];
        ...
        assign xbar_RRESP[
            ((mst*SLV_AMT + slv)+1)*TRANS_WR_RESP_W-1 -: TRANS_WR_RESP_W
        ] =
        xbar_to_slv_RRESP[
            ((slv*MST_AMT + mst)+1)*TRANS_WR_RESP_W-1 -: TRANS_WR_RESP_W
        ];

        assign xbar_RLAST[mst*SLV_AMT+slv] =
               xbar_to_slv_RLAST[slv*MST_AMT+mst];

        assign xbar_RVALID[mst*SLV_AMT+slv] =
               xbar_to_slv_RVALID[slv*MST_AMT+mst];

        assign xbar_to_slv_RREADY[slv*MST_AMT+mst] =
               xbar_RREADY[mst*SLV_AMT+slv];
        ...
        assign xbar_BVALID[mst*SLV_AMT+slv] =
               xbar_to_slv_BVALID[slv*MST_AMT+mst];

        assign xbar_to_slv_BREADY[slv*MST_AMT+mst] =
               xbar_BREADY[mst*SLV_AMT+slv];
...
begin : GEN_DSP_SLV
    ...
    (
        ...
        // Response ID
        //--------------------------------------------------
        .r_trans_mst_id     (r_trans_mst_id_o[(slv +1) * TRANS_MST_ID_W-1 -: TRANS_MST_ID_W]),
        .b_trans_mst_id     (b_trans_mst_id_o[(slv +1) * TRANS_MST_ID_W-1 -: TRANS_MST_ID_W]),

        //--------------------------------------------------
        // FIFO Request
        //--------------------------------------------------
        .fifo_ar_req        (fifo_ar_req_o[(slv +1) * MST_AMT-1 -: MST_AMT]),
        .fifo_aw_req        (fifo_aw_req_o[(slv +1) * MST_AMT-1 -: MST_AMT]),
        ...
        .s_ARVALID_o    (slv_dsp_ARVALID[slv]),
        .s_ARREADY_i    (slv_dsp_ARREADY[slv]),
        ...
        .ma_ARVALID_i   (xbar_to_slv_ARVALID[(slv+1)*MST_AMT-1 -: MST_AMT]),
        .ma_ARREADY_o   (xbar_to_slv_ARREADY[(slv+1)*MST_AMT-1 -: MST_AMT]),
        ...
        .s_RVALID_i     (slv_dsp_RVALID[slv]),
        .s_RREADY_o     (slv_dsp_RREADY[slv]),
        ...
        .ma_RVALID_o    (xbar_to_slv_RVALID[(slv+1)*MST_AMT-1 -: MST_AMT]),
        .ma_RREADY_i    (xbar_to_slv_RREADY[(slv+1)*MST_AMT-1 -: MST_AMT]),
        ...
        .s_AWVALID_o    (slv_dsp_AWVALID[slv]),
        .s_AWREADY_i    (slv_dsp_AWREADY[slv]),
        ...
        .ma_AWVALID_i   (xbar_to_slv_AWVALID[(slv+1)*MST_AMT-1 -: MST_AMT]),
        .ma_AWREADY_o   (xbar_to_slv_AWREADY[(slv+1)*MST_AMT-1 -: MST_AMT]),
        ...
        .s_WVALID_o     (slv_dsp_WVALID[slv]),
        .s_WREADY_i     (slv_dsp_WREADY[slv]),
        ...
        .ma_WVALID_i    (xbar_to_slv_WVALID[(slv+1)*MST_AMT-1 -: MST_AMT]),
        .ma_WREADY_o    (xbar_to_slv_WREADY[(slv+1)*MST_AMT-1 -: MST_AMT]),
        ...
        .s_BVALID_i     (slv_dsp_BVALID[slv]),
        .s_BREADY_o     (slv_dsp_BREADY[slv]),
        ...
        .ma_BVALID_o    (xbar_to_slv_BVALID[(slv+1)*MST_AMT-1 -: MST_AMT]),
        .ma_BREADY_i    (xbar_to_slv_BREADY[(slv+1)*MST_AMT-1 -: MST_AMT])
    );
