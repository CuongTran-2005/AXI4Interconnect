...
parameter TRANSACTION_LENGTH_WIDTH          = 8;
...
wire [TRANSACTION_LENGTH_WIDTH*MASTER_NUM-1:0]      m_ARLEN_i;
...
wire [TRANSACTION_LENGTH_WIDTH*MASTER_NUM-1:0]      m_AWLEN_i;
...
wire [TRANSACTION_RESP*SLAVE_NUM-1:0]               s_BRESP_i;
...
// ==========================================
// KHAI BÁO TÍN HI?U ??U RA (OUTPUT -> wire)
// ==========================================
...
wire [TRANSACTION_LENGTH_WIDTH*SLAVE_NUM-1:0]         s_AWLEN_o;
...
// ar
wire [TRANSACTION_ID_WIDTH*SLAVE_NUM-1:0]             s_ARID_o;
wire [TRANSACTION_ADDR_WIDTH*SLAVE_NUM-1:0]           s_ARADDR_o;
wire [TRANSACTION_BURST_WIDTH*SLAVE_NUM-1:0]          s_ARBURST_o;
wire [TRANSACTION_LENGTH_WIDTH*SLAVE_NUM-1:0]         s_ARLEN_o;
wire [TRANSACTION_SIZE_LENGTH*SLAVE_NUM-1:0]          s_ARSIZE_o;
